...
electron_1.ipcMain.on("submit-hash", function (event, args) { return __awaiter(void 0, void 0, void 0, function () {
    var options, response, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                options = args;
                return [4 /*yield*/, (0, electron_fetch_1.default)("".concat(SERVER_URL, "/api/hash"), {
                        method: "POST",
                        headers: {
